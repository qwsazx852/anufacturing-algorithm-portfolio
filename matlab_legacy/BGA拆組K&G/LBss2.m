...
% DC2=[0.9297	0.911	0.797	0.797	0.797	0.797	0.482	0.294	0.266	0.266	0.224	0.1727	0.1727	0.1727	0.1354	0.0234	0.0234	0.0234];%liaison單一零件拆裝成本
...
ANS=Rmetric(savea);
SS=[SS, savea(find(ANS==min(ANS),1),:)];
