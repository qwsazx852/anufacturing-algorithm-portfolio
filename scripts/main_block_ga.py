...
def run_block_ga():
    ...
    plot_results(history_metrics, "Block-Based GA 拆解優化")
...
def plot_results(history, title):
    ...
    plt.tight_layout()
    plt.savefig('scripts/convergence_block_ga.png')
    print("圖表已儲存至 scripts/convergence_block_ga.png")
